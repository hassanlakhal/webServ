...
/*   Updated: 2024/01/07 01:12:37 by hlakhal-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include"Bloc.hpp"

Bloc::Bloc(const std::string& nameFile) : nameFile(nameFile)
{
...
bool referenceConfig(const std::string& value)
{
...
void parsingValue(const std::string& value)
{
   
}

void Bloc::loadLocation()
{
    // Location config;
